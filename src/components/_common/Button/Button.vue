...
const classes = computed(() => {
  ...
  return {
    'flex justify-center items-center text-center relative font-medium rounded-lg text-sm px-5 h-11 focus:outline-none disabled:opacity-75 transition duration-100 ease-in-out"': true,
